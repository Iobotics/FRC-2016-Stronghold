...
import com.ni.rio.*; 
import com.sun.squawk.io.j2me.dserror.*; 
...
import edu.wpi.first.wpilibj.fpga.*; 
import edu.wpi.first.wpilibj.image.*; 
import edu.wpi.first.wpilibj.interfaces.*; 
import edu.wpi.first.wpilibj.livewindow.*; 
import edu.wpi.first.wpilibj.parsing.*; 
import edu.wpi.first.wpilibj.smartdashboard.*; 
import edu.wpi.first.wpilibj.util.*; 
import edu.wpi.first.wpilibj.visa.*; 
...
public class Vision2016_2 extends PApplet {
...
public void draw() {
  ...
  */
  ...
  float elevationAngle = (float) networkTable.getNumber("gimbal-elevation-position", 0.0f);
...
public float getTriangleArea(float edge1, float edge2, float edge3) { //Compute the area of a triangle with Hero's formula
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Vision2016_2" };
    if (passedArgs != null) {
